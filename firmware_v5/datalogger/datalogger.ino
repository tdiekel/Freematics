...
PID_POLLING_INFO obdData[] = {
    ...
    {PID_COOLANT_TEMP, 3},
    {PID_INTAKE_TEMP, 3},
    {PID_SHORT_TERM_FUEL_TRIM_1, 4},
    {PID_LONG_TERM_FUEL_TRIM_1, 4},
    {PID_SHORT_TERM_FUEL_TRIM_2, 4},
    {PID_LONG_TERM_FUEL_TRIM_2, 4},
    {PID_INTAKE_MAP, 4},
    {PID_MAF_FLOW, 4},
    {PID_AUX_INPUT, 4},
    {PID_RUNTIME, 4},
    {PID_DISTANCE_WITH_MIL, 4},
    {PID_COMMANDED_EGR, 4},
    {PID_EGR_ERROR, 4},
    {PID_COMMANDED_EVAPORATIVE_PURGE, 4},
    {PID_FUEL_LEVEL, 4},
    {PID_WARMS_UPS, 4},
    {PID_DISTANCE, 4},
    {PID_EVAP_SYS_VAPOR_PRESSURE, 4},
    {PID_BAROMETRIC, 4},
    {PID_CATALYST_TEMP_B1S1, 4},
    {PID_CATALYST_TEMP_B2S1, 4},
    {PID_CATALYST_TEMP_B1S2, 4},
    {PID_CATALYST_TEMP_B2S2, 4},
    {PID_CONTROL_MODULE_VOLTAGE, 4},
    {PID_ABSOLUTE_ENGINE_LOAD, 4},
    {PID_AIR_FUEL_EQUIV_RATIO, 4},
    {PID_RELATIVE_THROTTLE_POS, 4},
    {PID_AMBIENT_TEMP, 4},
    {PID_ABSOLUTE_THROTTLE_POS_B, 4},
    {PID_ABSOLUTE_THROTTLE_POS_C, 4},
    {PID_ACC_PEDAL_POS_D, 4},
    {PID_ACC_PEDAL_POS_E, 4},
    {PID_ACC_PEDAL_POS_F, 4},
    {PID_COMMANDED_THROTTLE_ACTUATOR, 4},
    {PID_TIME_WITH_MIL, 4},
    {PID_TIME_SINCE_CODES_CLEARED, 4},
    {PID_ETHANOL_FUEL, 4},
    {PID_FUEL_RAIL_PRESSURE, 4},
    {PID_HYBRID_BATTERY_PERCENTAGE, 4},
    {PID_ENGINE_OIL_TEMP, 4},
    {PID_FUEL_INJECTION_TIMING, 4},
    {PID_ENGINE_FUEL_RATE, 4},
    {PID_ENGINE_TORQUE_DEMANDED, 4},
    {PID_ENGINE_TORQUE_PERCENTAGE, 4},
    {PID_ENGINE_REF_TORQUE, 4}};
